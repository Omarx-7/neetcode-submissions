...
#Given beginning of singly linked list (head), reverse the list and return the new beginning of the list.
...
class Solution:
    def reverseList(self, head: Optional[ListNode]) -> Optional[ListNode]:
        ...
        while curr: #i.e. while curr is not empty/NULL
            nxt = curr.next #Here we store the next node from the curr node, this way we dont lose it after we reverse the white pointer
